...
from system_manage.views.customer_manage_views.order_manage_views import OrderManageView, CustomerOrderManageView, edit_order, delete_order, order_status
...
urlpatterns = [
    ...
    path('order/edit/', edit_order),
    path('order/delete/', delete_order),
    path('order/status/', order_status),
    path('order-manage/<int:customer_id>/', CustomerOrderManageView.as_view(), name='customer_order_manage'),
]